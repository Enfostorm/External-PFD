...
class SerialRemoteApp(App):
    ...
    def serialWriteValues(self, dt):
        ...
        stringToWrite = str(self.roundedStr(pitch, 3) + ';' + self.roundedStr(roll, 3) + ';' + self.roundedStr(slip, 5) + ';' + self.roundedStr(heading, 3) + ';' + self.roundedStr(headingBug, 3) + '\n')
        print(stringToWrite)
        self.ser.write(stringToWrite.encode())
    ...
    def roundedStr(self, number, significantNumbers):
        return str(round(pow(10, significantNumbers)*number)/pow(10, significantNumbers))
